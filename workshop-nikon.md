...
- ライブラリ・フレームワーク・言語の使い方を扱うときは **必ず `#context7` MCP Server で最新ドキュメントを参照する**。
- 知っているつもりでも調べる。学習データは過去のもので古くなっている可能性が高いため、馴染みのある技術であっても確認する。
- 例: Astro の content collections 仕様、Tailwind のクラス、pnpm のコマンドなど。
```
...
<img src="github-copilot-workshop/img/Octocat-red.png" alt="CODE フェーズの Octocat" style="float: right; width: 100px; margin: 0 0 1em 1em;">
...
>    ラベル: enhancement, ui
>
> 2. タイトル: サイドバーの現在セクションにネオングローを追加
...
<img src="github-copilot-workshop/img/Octocat-yellow.png" alt="REVIEW フェーズの Octocat" style="float: right; width: 100px; margin: 0 0 1em 1em;">
